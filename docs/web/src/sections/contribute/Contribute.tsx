...
const contributeSteps: IStep[] = [
    {
        ...
        cta: (
            <Button icon={<VscRepoForked />} href="https://github.com/srilakshmikanthanp/clipbirdesk">
                Fork
            </Button>
        )
    },
    ...
    },
    {
        ...
        cta: (
            <Button icon={<IoIosGitPullRequest />} href="https://github.com/srilakshmikanthanp/clipbirdesk/compare">
                Submit PR
            </Button>
        )
    }
...
const supportSteps: IStep[] = [
    {
        ...
        cta: (
            <Button icon={<LuStar />} href="https://github.com/srilakshmikanthanp/clipbirdesk">
                Star
            </Button>
        )
    },
