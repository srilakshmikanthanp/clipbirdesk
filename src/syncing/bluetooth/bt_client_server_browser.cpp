...
BtClientServerBrowser::BtClientServerBrowser(
  ...
  QObject::connect(
    sdpBrowser,
    &BtDeviceBrowser::onBrowsingStarted,
    this,
  ...
  QObject::connect(
    sdpBrowser,
    &BtDeviceBrowser::onBrowsingStopped,
    this,
  ...
  QObject::connect(
    sdpBrowser,
    &BtDeviceBrowser::onServiceAdded,
    this,
  ...
  QObject::connect(
    sdpBrowser,
    &BtDeviceBrowser::onServiceRemoved,
    this,
  ...
  QObject::connect(
    sdpBrowser,
    &BtDeviceBrowser::onBrowsingStartFailed,
    this,
  ...
  QObject::connect(
    sdpBrowser,
    &BtDeviceBrowser::onBrowsingStopFailed,
    this,
