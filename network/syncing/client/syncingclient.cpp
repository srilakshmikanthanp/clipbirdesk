 ...
 */
void SyncingClient::processSyncingPacket(const packets::SyncingPacket& packet) {
 ...
 * @param parent Parent
 */
SyncingClient::SyncingClient(QObject* parent) : DiscoveryClient(parent) {
